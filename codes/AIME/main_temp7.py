...
from solver_temp7 import MultiHopSolver
import torch
import gc
import json
...
def main():
    ...
    parser.add_argument('--query_mode', type=str, default="q1", help='Query mode')
    ...
    subject_data = ds['train']
    print(f"Found {len(subject_data)} problems for AIME")
    ...
    for prob_num in tqdm(range(start_prob, end_prob + 1)):
        ...
        solver.solve_problem('AIME', prob_num, problem)
