...
from multihop_solver2 import MultiHopSolver
import torch
import gc
import random
import wandb
...
def main():
    ...
    #subjects = ds['test'].unique('category')
    subjects = ['chemistry']
    #subjects = subjects[:5]
    ...
    for subject in subjects:
        ...
        seed = 42
        random.seed(seed)
        problem_index = random.sample(range(1, end_prob + 1), 100)
        # problem_index = range(1, end_prob + 1)
        for prob_num in problem_index:
