...
if __name__ == "__main__":
    ...
    for data in tqdm(full_data):
        ...
        if "Not helpful at all" in evaluation:
            eval = 0
        elif "Partially helpful" in evaluation:
            eval = 1
        elif "Mostly helpful" in evaluation:
            eval = 2
        elif "Fully helpful" in evaluation:
            eval = 3
        else:
            eval = -1
    ...
    with open(f"/home/minhae/multihop-RAG2/ablation/gpqa/{args.mode}_results_1.json", "w") as file:
